...
public class Message implements Serializable {
    ...
    public enum MessageType {
        NAME_REQUEST, USER_NAME, NAME_ACCEPTED, TEXT_MESSAGE
        , ERROR_MESSAGE, USER_ADDED, USER_REMOVED
        , PRIVATE_MESSAGE, FILE_MESSAGE, FILE_MESSAGE_FOR_ALL
        , FILE_MESSAGE_REQUEST, FILE_MESSAGE_RESPONSE
    }
